...
<head>
    ...
    <title>Website for Hospitals to order the plasma</title>
...
<body>
	...
	if(request.getParameter("request") != null && request.getParameter("hospital") != null && request.getParameter("cancel") != null) 
	{
		...
		String cancelQuery = "update request set Request_status = 'cancelled' where donation_id = "+donation_id+" and Request_status = 'requested'";
		if(dao.putData(cancelQuery) > 0) 
		{
			String cancelQuery1 = "update donation set Hospital_request_status = 'cancelled' where donation_id = "+donation_id+" and Hospital_request_status = 'requested'" ;
            ...
            <div class="container">
                <div class="row col-det">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <ul class="ulright">
                                <li>
                                    <form action="../../LogoutControlH" method="post">
                                    	<button id="logoutt" type="submit" class="btn btn-success">
                    ...
                    <div class="col-md-9 nav-col">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                           <li class="nav-item">
                                        <a class="btn btn-primary" href="#mytable1" role="button">A</a>
                                    </li>
                                    
                                     <li class="nav-item">
                                        <a class="btn btn-primary" href="#mytable2" role="button">B</a>
                                    </li>
                                    
                                     <li class="nav-item">
                                        <a class="btn btn-primary" href="#mytable3" role="button">O</a>
                                    </li>
                                    
                                     <li class="nav-item">
                                        <a class="btn btn-primary" href="#mytable4" role="button">AB</a>
                                    </li>
                                    

                                    <li class="nav-item">
                                        <a class="btn btn-primary" href="#mytable5" role="button">Request List</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
...
<div class="p-3 mb-2 bg-danger text-white">List of A+ and A- Blood Group</div>
  ...
  %>
    <tr>
      ...
      <td><%=resultSet.getInt("Quantity_of_plasma") %></td>
       ...
       <td><a class="btn btn-primary" href="Home3.jsp?request=<%= resultSet.getInt("donation_id") %>&hospital=<%=loggedInHospitalId%>">Request Now</a></td>
    </tr>
    <%
  }
    %>
...
<div class="p-3 mb-2 bg-danger text-white">List of B+ and B- Blood Group</div>
  ...
  %>
    <tr>
      ...
      <td><%=resultSet1.getInt("Quantity_of_plasma") %></td>
       ...
       <td><a class="btn btn-primary" href="Home3.jsp?request=<%= resultSet1.getInt("donation_id") %>&hospital=<%=loggedInHospitalId%>">Request Now</a></td>
    </tr>
    <%
  }
    %>
...
<div class="p-3 mb-2 bg-danger text-white">List of O+ and O- Blood Group</div>
  ...
  %>
    <tr>
      ...
      <td><%=resultSet2.getInt("Quantity_of_plasma") %></td>
       ...
       <td><a class="btn btn-primary" href="Home3.jsp?request=<%= resultSet2.getInt("donation_id") %>&hospital=<%=loggedInHospitalId%>">Request Now</a></td>
    </tr>
    <%
  }
    %>
...
<div class="p-3 mb-2 bg-danger text-white">List of AB+ and AB- Blood Group</div>
  ...
  %>
    <tr>
      ...
      <td><%=resultSet3.getInt("Quantity_of_plasma") %></td>
       ...
       <td><a class="btn btn-primary" href="Home3.jsp?request=<%= resultSet3.getInt("donation_id") %>&hospital=<%=loggedInHospitalId%>">Request Now</a></td>
    </tr>
    <%
  }
    %>
...
<div class="p-3 mb-2 bg-danger text-white">List of Requests</div>
    ...
    <tr>
      ...
      <td><%=resultSet4.getInt("Quantity_of_plasma") %></td>
       ...
       <%
       		...
       		{
       		%>
       			<td><%= resultSet4.getString("Hospital_request_status") %>&nbsp;&nbsp;&nbsp;&nbsp;
       			<a class="btn btn-primary" href="Home3.jsp?request=<%= resultSet4.getInt("donation_id") %>&hospital=<%=loggedInHospitalId%>&cancel=1">Cancel</a>
       			</td>
