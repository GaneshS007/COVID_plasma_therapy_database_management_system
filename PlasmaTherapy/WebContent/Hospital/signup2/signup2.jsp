...
<head>
<title>Hospital Sign UP page</title>
<!-- Meta tag Keywords -->
...
<body><link rel="stylesheet" href="css/demobar_w3_4thDec2019.css">
    ...
    if(request.getParameter("submit_btn") != null)
    {
        ...
        String sql = String.format("insert into hospital (Name, Phone_no, Address, Email, Username, Password) values('%s', '%s','%s', '%s', '%s', '%s')", Name, Number, Address, mail, username, password);        
        if(dao.putData(sql) > 0)
        {
        %>
            <script type="text/JavaScript">
                alert("Signup successful!! You can login now...");
                window.location.href="../../Hospital/login2/login2.jsp";                    
            </script>
        <%
        }
        else
        ...
        %>
            <script type="text/JavaScript">
                alert("There seems to be an issue, try again! Username may already exist..");
	...
	<h2 class="sub-head">Sign Up</h2>
		<div class="sub-main">	
			<form method="post">
				...
				<input placeholder="Phone Number" name="Number" id="Number" type="text" required>
					<span class="icon2"><i class="fa fa-phone" aria-hidden="true"></i></span><br>

				<input placeholder="Address" name="Address" id="Address" type="text" required>
					<span class="icon3"><i class="fa fa-home" aria-hidden="true"></i></span><br>

				<input placeholder="Mail" name="mail" id="mail" type="text" required>
				...
				<input  placeholder="Confirm Password" name="cpassword" id="cpassword" type="password" required>
					<span class="icon6"><i class="fa fa-unlock" aria-hidden="true"></i></span><br>
