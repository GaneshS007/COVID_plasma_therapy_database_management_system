...
<head>
    ...
    <title>Website for Donor Registration</title>
...
<h2 class="sub-head">Donor Details</h2>
    ...
    <button id="Donatenow" type="button" class="btn btn-success btn-sm float-right">X</button></a>
  </div>
    <div class="clear"></div>
    ...
    <section id="about" class="contianer-fluid about-us">
        <div class="container">
            <div class="row session-title">
                <h2 class="headers">Motivation</h2>
