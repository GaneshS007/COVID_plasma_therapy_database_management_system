...
<head>
    ...
    <title>Website for Blood Bank to fill the donation details</title>
...
<body>
    ...
    if(request.getParameter("submit_btn") != null)
    {
        ...
        if(rs.next())
        {
        	...
        	if(rs1.next())
        	{
	            ...
	            {
	        		String status_update = "update donor set Donation_status = 'completed', Incentive_status = 'Given' where donor_id = "+Donor_id+"";
        ...
        %>
            <script type="text/JavaScript">
                alert("Data entered in the registration doesn't match...");
            	window.location.href="Home1.jsp";               
            </script>
        <%	
        }
    ...
    <%
    if(request.getParameter("submit_btn1") != null)
    {
        ...
        String sql = String.format("insert into donor (Name, Phone_no, Address, Age, Weight, Blood_Group, Covid_pos_date, Covid_neg_date) values('%s', '%s','%s', %s , %s ,'%s','%s','%s')", name, Phone_Number, Address, Age, Weight, Blood_Group, Covid_Pos, Covid_Neg);        
                    ...
                    <div class="col-md-9 nav-col">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                           <li class="nav-item">
                                        <a class="nav-link" href="#Donateit">Donation Details</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="../../BloodBank/Home2/Home2.jsp">Hospital</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
...
<div class="sub-main">
      <form method="post">
        ...
        <button type="submit" name="submit_btn2">Submit</button>
        </div>
      </form>
    </div>
	 
      <%if(request.getParameter("submit_btn2") != null) 
      {
      		boolean flag = false;
      %>
    	  <div>
        ...
        {%>
            <tr>
              ...
              <td><%= rs.getString("Incentive_status") %></td>
            </tr>
        <%
        	flag = true;
        }
        ...
        if(flag == false){
        	%>
        	<script type="text/JavaScript">
            	alert("There is no matching donor, check the name and phno or Register");
        	</script>
        	<%
        }
      }
		...
		<div id="Mydiv" class="main-agileits"
			...
			<div class="sub-main">
				...
				<form method="post">
					...
					<input placeholder="Quantity of Plasma in Units 1 unit = 200ml" name="plasma" type="text" id="plasma"> 
					<br>
					...
					<br>
					<button type="submit" name="submit_btn" onclick="return validation();">Submit</button>
		...
		<div id="Mydiv1" class="main-agileits" style="display: none; border-style: solid;">
			...
			<div class="sub-main">
				<form method="post">
					...
					<button type="submit" name="submit_btn1" onclick="return validate();">Donate</button>
				</form>
