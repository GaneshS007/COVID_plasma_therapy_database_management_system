...
<head>
<title>Blood Bank Sign UP page</title>
<!-- Meta tag Keywords -->
...
<body><link rel="stylesheet" href="css/demobar_w3_4thDec2019.css">
    ...
    if(request.getParameter("submit_btn") != null)
    {
        ...
        String sql = String.format("insert into blood_bank (Name, Phone_no, Address, Email, Username, Password) values('%s', '%s','%s', '%s', '%s', '%s')", Name, Number, Address, mail, username, password);        
